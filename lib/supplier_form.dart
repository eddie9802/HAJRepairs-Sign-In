...
class _CustomerFormState extends State<CustomerForm> {
  ...
  final List<String> _customerForm = ["Registration Number", "Company", "Driver Name", "Driver Number" "Reason For Visit"];
  final List<String> _customerFormQuestions = [
                                              "Would you like to Sign in or out?"
                                              "What is your registration number?",
                                              "What company are you from?",
                                              "What is your driver name?"
                                              "What is your driver number?  Enter \"N/A\" if you don't have one."
